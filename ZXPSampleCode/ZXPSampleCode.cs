...
namespace ZXPSampleCode
{
    class ZXPSampleCode
    {
        ...
        public bool IsZXP9_600
        {
            get { return _isZXP9_600; }
        }
        ...
        private void IdentifyZMotifPrinter(ref Job job)
        {
            try
            {
                ...
                string xmlCapabilities = string.Empty;
                ...
                GetCapabilities(ref job,out xmlCapabilities);
 
                //handle the Jaguar printer as ZXP7, they have the same image size and don't need to get the card type
                if (model.Contains("7") || model.Contains("ZC"))
                    _isZXP7 = true;
                else
                    _isZXP7 = false;

                if (model.Contains("9") && xmlCapabilities.Contains("<print_resolution>600</print_resolution>"))
                    _isZXP9_600 = true;
                else
                    _isZXP9_600 = false;
            }
        ...
        private short GetCapabilities(ref Job job,out string xmlCapabilities)
        {
            try
            {
                return job.Device.GetCapabilities( CapabilitiesReportTypeEnum.General, out xmlCapabilities);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
        ...
        public bool PrintWithMag()
        {
            ...
            try
            {
                ...
                {
                    g.PrinterModel = ZMotifGraphics.PrinterModelTypeEnum.ZXPSeries9_600;
                    _nameFrontImage = "ZXP9Front600.bmp";
                    _nameBackImage = "Back600ForMag.bmp";
                    imageWidth = 2046;
                    imageHeight = 1296;
                    
                }
                else
                    _nameFrontImage = "ZXP8Front.bmp";
                ...
                g.DrawImage(ref imgFront, ZMotifGraphics.ImagePositionEnum.Centered, imageWidth, imageHeight, 0);
                ...
                g.DrawImage(ref imgBack, ZMotifGraphics.ImagePositionEnum.Centered, imageWidth, imageHeight, 0);
        ...
        public bool Print_1(string cardType)
        {
            ...
            try
            {
                ...
                else if (_isZXP9_600)
                {
                    g.PrinterModel = ZMotifGraphics.PrinterModelTypeEnum.ZXPSeries9_600;
                    _nameFrontImage = "ZXP9Front600.bmp";
                    _nameBackImage = "ZXP9Back600.bmp";
                    imageWidth = 2046;
                    imageHeight = 1296;
                ...
                g.DrawImage(ref img, ZMotifGraphics.ImagePositionEnum.Centered, (int)(imageWidth*0.5), (int)(imageHeight*0.5), 0);
        ...
        public bool Print_2(string cardType)
        {
            ...
            try
            {
                ...
                g.DrawImage(ref img, ZMotifGraphics.ImagePositionEnum.Centered, imageWidth, imageHeight, 0);
        ...
        public bool Print_5(string cardType)
        {
            ...
            try
            {
                ...
                g.DrawImage(ref fishByteArray, 0, 0, imageWidth, imageHeight, 0);
        ...
        public bool Print_6(string cardType)
        {
            ...
            try
            {
                ...
                g.DrawImage(ref img, 50, 50, imageWidth, imageHeight, 0);
        ...
        private string GetContactlessCardType(ref Job job)
        {
            try
            {
                ...
                {
                    if (card.ToUpper().Contains("CONTACTLESS") || card.ToUpper().Contains("MIFARE"))
                        return card;
                }
                return string.Empty;
            }
        ...
        private string GetContactCardType(ref Job job)
        {
            try
            {
                ...
                foreach (string card in arrCardTypes)
                {
                    if (card.Contains("SLE") || card.Contains("CONTACT"))
                        return card;
                }
                return string.Empty;
            }
        ...
        private string GetMagneticCardType(ref Job job)
        {
            try
            {
                ...
                foreach (string card in arrCardTypes)
                {
                    if (card.ToUpper().Contains("HICO") || card.ToUpper().Contains("MAG"))
                        return card;
                }
                return string.Empty;
            }
